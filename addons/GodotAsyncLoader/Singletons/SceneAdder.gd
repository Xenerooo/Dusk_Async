...
func add_scene(on_done_cb : FuncRef, target : Node, path : String, pos : Vector2, is_pos_global : bool, cb : FuncRef, instance : Node, data : Dictionary, has_priority : bool) -> void:
	var entry := {
		"target" : target,
